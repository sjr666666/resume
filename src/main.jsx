...
const projects = [
  ...
  },
  {
    ...
    github: 'https://github.com/liangliang205/promotion_platform',
      ...
      <main>
        <section className="hero" id="top">
          ...
          <div className="hero-content">
            ...
            <div className="hero-bottom reveal">
              ...
              <a className="round-link" href="#projects" aria-label="跳转到精选项目" data-tooltip="跳转到精选项目"><ArrowDownRight size={28} /></a>
            </div>
          </div>
        ...
        <section className="about section" id="about">
          ...
          <div className="about-main">
            ...
            <div className="about-details reveal">
              ...
              <div className="about-copy"><p>我以 Java 后端开发为主，也能完成 React 前端与 AI 能力接入。最近独立负责 AI 药管家，从架构设计、权限体系、提醒状态机，到 OCR 识药与 DeepSeek 分层分析，完成了一个真实可用的产品闭环。</p><p>我在意代码背后的用户：系统是否清晰、错误是否可控、功能是否真的减少了问题。正在寻找互联网 / AI 方向的后端开发、Java 开发或全栈开发机会。</p><div className="contact-line"><a href="mailto:itjingrong@qq.com"><Mail size={15} /> itjingrong@qq.com</a><span><MapPin size={15} /> 深圳 · 可随时到岗</span></div><div className="toolkit"><span className="toolkit-label">CODING WORKFLOW</span><div className="toolkit-tools"><span className="tool-badge trae"><img src={`${import.meta.env.BASE_URL}tool-icons/trae.svg`} alt="" /><i>TRAE CN</i></span><span className="tool-badge workbuddy"><img src={`${import.meta.env.BASE_URL}tool-icons/workbuddy.svg`} alt="" /><i>WORKBUDDY</i></span><span className="tool-badge codex"><img src={`${import.meta.env.BASE_URL}tool-icons/codex.svg`} alt="" /><i>CODEX</i></span><span className="tool-badge claude"><img src={`${import.meta.env.BASE_URL}tool-icons/claude.svg`} alt="" /><i>CLAUDE CODE</i></span></div><p>熟练使用国内外 AI 编程工具辅助开发、调试与交付。</p></div></div>
            </div>
        ...
        <section className="projects section" id="projects">
          ...
          <div className="projects-main"><div className="section-heading reveal"><p className="eyebrow">Systems in the wild</p><h2>精选项目</h2><span className="heading-note">真实业务，真实约束，真实交付。</span></div>
            ...
            <a className="github-link reveal" href="https://github.com/sjr666666" target="_blank" rel="noreferrer"><span className="github-icon"><Code2 size={20} /></span><span className="github-copy"><strong>查看我的 GitHub 主页</strong><small>更多项目、源码与开发记录</small></span><span className="github-arrow"><ArrowUpRight size={20} /></span></a>
          </div>
        </section>
