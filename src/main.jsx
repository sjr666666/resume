        ...
        <section className="about section" id="about">
          ...
          <div className="about-main">
            ...
            <div className="about-details reveal">
              <div className="portrait-frame"><div className="portrait-image-wrap"><img className="portrait-image" src="/avatar.png" alt="石敬荣个人照片" /><div className="portrait-tint" /></div><div className="portrait-orbit orbit-one" /><div className="portrait-orbit orbit-two" /><div className="portrait-id"><strong>石敬荣</strong><span>SJR / JAVA BACKEND</span></div><span className="portrait-label">BUILD / TEST / SHIP</span></div>
